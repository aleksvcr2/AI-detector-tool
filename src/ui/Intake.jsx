...
export default function Intake({ onFile, onText, busy, progress, error, note, source, hasReport }) {
            ...
            <div className="border border-[#CFC6B2] bg-[#F7F3EA]">
              ...
              <div className="flex items-center justify-between border-t border-[#CFC6B2] px-4 py-2">
                ...
                <button
                  ...
                  onClick={() => onText(draft, "pasted text")}
            ...
            {SPECIMENS.map((s) => (
              ...
              >
                <span className="flex items-baseline gap-2">
                  <span className="font-['Fragment_Mono'] text-[12px] text-[#5B33C7]">{s.id}</span>
                  <span className="text-[14px] font-medium">{s.label.split("· ")[1]}</span>
                </span>
